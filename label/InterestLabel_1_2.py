...
def Interest_1_2(keys):
    ...
    labelDic = {
        ...
        '汽车服务_汽车内容': ['汽车_低档车','汽车_中档车', '汽车_高档车', '汽车_二手车', '汽车_车辆养护'],
        ...
        '视频直播_VR视频':['文化娱乐_电影电视', '文化娱乐_艺术展览', '文化娱乐_酒吧KTV', '文化娱乐_演出', '科技数码_数码摄像'],
        ...
        '母婴亲子_月子中心':['母婴儿童_孕妇用品', '母婴儿童_胎教相关', '母婴儿童_宝宝用品', '母婴儿童_宝宝食品', '母婴儿童_写真拍照', '母婴儿童_儿童玩具', '教育培训_学前教育', '服饰箱包_童装童鞋'],
        ...
        '理财_外汇':['金融理财_股票基金', '金融理财_银行理财'],
        '理财_贵金属':['金融理财_股票基金', '金融理财_银行理财'],
